...
Besides processing normal transactions, participants can also request to take
UTxO they can spend out of the Head and make it available on the main chain
using a \mtxDecrement{} transaction --- the whole process is called decommit.
...
\begin{itemize}
  ...
  \item Allow for incremental decommits while head is open.
\end{itemize}
