...
\begin{menumerate}
	...
	stay unchanged and the new state is governed again by $\nuHead$
	\[
		\textcolor{red}{(\stOpen,\cid,\hydraKeys,\Tcontest,v,\eta) \xrightarrow[\mathsf{CloseType}]{\stClose} (\stClosed,\cid,\hydraKeys,\Tcontest,v',s',\eta', \contesters,\tfinal)}
	\]
...
\begin{menumerate}
	...
	stay unchanged and the new state is governed again by $\nuHead$
	\[
		\textcolor{red}{(\stClosed,\cid,\hydraKeys,\Tcontest,v,s,\eta,\contesters,\tfinal) \xrightarrow[\mathsf{ContestType}]{\stContest} (\stClosed,\cid,\hydraKeys,\Tcontest,v',s',\eta',\contesters',\tfinal')}
	\]
...
\textcolor{red}{An intermediate partial fanout transaction consists of:}
\begin{itemize}
...
A final partial fanout transaction consists of:}
\begin{itemize}
