...
\begin{menumerate}
	...
	\[
		\mathsf{ovhd}' = \mathsf{ovhd}
	\]
	where $\mathsf{ovhd}$ is the ADA in the head UTxO not belonging to any L2 UTxO (minimum-UTxO overhead), set at initialisation time and invariant for the head's lifetime.}
\end{menumerate}
