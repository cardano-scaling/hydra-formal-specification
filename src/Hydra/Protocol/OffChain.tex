...
\textcolor{red}{\dparagraph{$\mathtt{partialFanoutTx}$.}}\quad \textcolor{red}{When a head needs to be finalized,
...
\textcolor{red}{A batch of size $n < N$ is posted as an intermediate $\mtxPartialFanout{}$ transaction, which
