					...
					\begin{walgo}{0.65}
						...
						\On{$(\hpRS,v,s,\underline{\tx}_{\mathsf{req}} ,\tx_\alpha,\tx_\omega)$ from $\party_j$}{
							...
							\Wait{$\hats = \bar{\mc S}.s ~ \land ~ v = \hatv$}{
								...
								$\eta \gets \combine(U)$ \;
								$\eta_\alpha \gets \combine(U_\alpha)$ \;
							...
							\Wait{$\hats=s$}{
								...
								\If{$\forall k \in [1..n]: (k,\cdot) \in \hatSigma$}{
									...
									\If{$\bar{\mc S}.U_\omega \ne \bot$}{
										$\PostTx{}~(\mathtt{decrementTx}, \hatv, \hats, \eta, \eta_\alpha, \eta_\omega, \bar{\mc S}.A)$ \;
									}

									\If{$\bar{\mc S}.U_\alpha \ne \bot$}{
										$\PostTx{}~(\mathtt{incrementTx}, \hatv, \hats, \eta, \eta_\alpha, \eta_\omega, \bar{\mc S}.A)$ \;
									}
